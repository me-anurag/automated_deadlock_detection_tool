...
def main():
    ...
    # Verify files exist
    for path in [allocate_sound_path, request_sound_path, deadlock_sound_path]:
        if not os.path.exists(path):
            print(f"Warning: File not found at {path}")

    sound_manager = SoundManager(allocate_sound_path, request_sound_path, deadlock_sound_path)
